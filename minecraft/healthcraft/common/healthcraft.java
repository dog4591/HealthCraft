...
@Mod(modid = "dog4591healthcraft", name = "Health Craft", version = "0.1.1.1")
...
public class healthcraft 
{
 ...
 public void load(FMLInitializationEvent event)
 {
	...
	GameRegistry.addRecipe(new ItemStack(healthcraft.foodtable), new Object[]
	{"YYY", "YXY", "YYY", 'X', Block.workbench, 'Y', Item.ingotIron});
 }
}
